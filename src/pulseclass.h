...
const UChar_t P_B11 =
    1 << 4; // bad left or right side in timing (T3 or T4 is out of range)
const UChar_t P_B22 =
    1 << 5; // bad left or right side in width (T5 or T6 is out of range)
...
public:
  ...
  Float_t T0 =
      99999; // time of the earliest *START* peak, relative to Tstmp, in samples
