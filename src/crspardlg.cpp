...
void DaqParDlg::AddLine_daq(int i, TGCompositeFrame* fcont1) {
  ...
  cframe[i]->AddFrame(f_inv,LayCC1);
  kk++;
  ...
  cframe[i]->AddFrame(f_acdc,LayCC1);
  kk++;
