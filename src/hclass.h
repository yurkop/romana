...
public:
  ...
  Float_t VarPulse(EventClass *e, PulseClass *p) {
    return *(Float_t *)((char *)p + ptr);
  }
  ...
  void Fill_02(HMap *map, Float_t x, Float_t y, Double_t *hcut_flag, int ncut);
...
#ifdef YUMO
  void Fill_03(HMap *map, Float_t x, Float_t y, Float_t z, Double_t *hcut_flag,
               int ncut);
  ...
  void (Mdef::*MFill)(EventClass *evt, Double_t *hcut_flag,
                      int ncut) = &Mdef::MFillDef;
...
public:
  ...
  void HHist2(mdef_iter md, TH1 *&hh, char *name, char *title, int i, int n1,
              float min1, float max1, int n2, float min2, float max2);
  void HHist3(mdef_iter md, TH1 *&hh, char *name, char *title, int i, int n1,
              float min1, float max1, int n2, float min2, float max2, int n3,
